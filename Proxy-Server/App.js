...
app.get("/api/data", (req, res) => {
  ...
  res.json({ message: "This is cached data! yes yes yes" });
});

// app.get("/api/data", (req, res) => {
//       res.set("Cache-Control", "no-store"); // Cache API response for 1 minute
//       res.json({ message: "This is cached data! yes yes" });
//     });
